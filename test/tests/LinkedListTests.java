...
class LinkedListTests {
	...
	void testClear() {
		...
		this.linkedList.clear();
		/**
		 * Linked list shoud now be clear
		 */

		// Test the empty of linked list
		assertTrue(this.linkedList.isEmpty());

		// Test the size of linked list is equal 0 or not
	...
	void testIndexOf() {
		...
		/**
		 * Linked list should now be: Data: a -> b -> c -> d Index: 0 -> 1 -> 2 -> 3
		 */

		// Test the index of data "a"
		assertEquals(0, this.linkedList.indexOf("a"));

		// Test the index of data "b"
		assertEquals(1, this.linkedList.indexOf("b"));

		// Test the index of data "c"
		assertEquals(2, this.linkedList.indexOf("c"));

		// Test the index of data "d"
		assertEquals(3, this.linkedList.indexOf("d"));

		// Test the index of not same data
		assertEquals(-1, this.linkedList.indexOf("e"));
	...
	void testContains() {
		...
		// Test the linked list contain "a" or not
		assertTrue(this.linkedList.contains("a"));

		// Test the linked list contain "b" or not
		assertTrue(this.linkedList.contains("b"));

		// Test the linked list contain "c" or not
		assertTrue(this.linkedList.contains("c"));

		// Test the linked list contain "d" or not
		assertTrue(this.linkedList.contains("d"));

		// Test the linked list contain "a" or not
		assertFalse(this.linkedList.contains("e"));
